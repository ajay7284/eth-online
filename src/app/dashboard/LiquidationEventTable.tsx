    ...
    <div className="p-4 bg-gray-900 text-gray-100 rounded-lg shadow-xl">
          ...
          <tbody>
            {paginatedData.map((item, index) => (
              <tr key={index} className="hover:bg-gray-800">
                ...
                <td className="p-2 border-b border-gray-700" dangerouslySetInnerHTML={{ __html: item.owner_link }} />
                <td className="p-2 border-b border-gray-700" dangerouslySetInnerHTML={{ __html: item.transaction_link }} />
      ...
      <div className="mt-4 flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          ...
          <span className="px-3 py-1 bg-gray-800 text-gray-100 rounded">
